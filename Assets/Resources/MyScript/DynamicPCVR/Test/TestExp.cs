...
public class TestExp : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        pos = new Vector3[]
        {
            new Vector3(-0.9106f, 0.3985f, 0.9938f),
            new Vector3(-0.9614f, 1.0715f, 0.9117f),
        };

        normal = new Vector3[]
        {
            new Vector3(0.3351f, -0.8693f, -0.3634f),
            new Vector3(0.4504f, -0.0543f, -0.8912f),
        };
        ...
        operation_list = new List<OperationType> 
        {
            ...
            OperationType.AddLine,
            OperationType.AddLine,
            OperationType.AddPress,
            OperationType.AddRotate, 
        };
    ...
    {
        if (currentIndex >= operation_list.Count - 1)
        {
            return;
        }
    ...
    {
        string dir = "Data/";
        string exp_dir = "Exp" + exp_index.ToString() + "/";
